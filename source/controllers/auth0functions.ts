 ...
 */
export async function updateUserMetadata(accessToken: string, userId: string, metadata: { [key: string]: any }): Promise<any> {
  try {
    ...
    console.error(`Error updating user metadata for user with ID ${userId}:`, error);
